...
.heading-img1 {
  ...
  <img src="../hassan_el_annabi/images/solfège2.png" alt="" width="60px" class="heading-img">
  <h1 class="heading">Leçons de Solfège</h1>
</div>
    ...
    $sql = "SELECT Prof_id, Nom, Spécialité, pfp FROM professeur WHERE Spécialité = 'Solfège'";
...
?>
    ...
    <div>
      <h3 class="heading1">Bienvenue dans nos cours de Solfège de l'école de Hassan El annabi !</h3>
      <p class="paragraph">Notre programme de solfège est méticuleusement élaboré pour fournir une expérience éducative à la fois sérieuse et divertissante, destinée à enrichir les connaissances musicales des étudiants de tous niveaux. L'objectif est de leur permettre d'acquérir une solide compréhension de la théorie musicale qui est essentielle à tout développement dans le domaine de la musique.

Les leçons de solfège sont dispensées par des formateurs compétents et chevronnés, spécialisés dans une vaste étendue de disciplines musicales. Que vous commenciez tout juste à découvrir les subtilités de la musique ou que vous soyez déjà un musicien confirmé aspirant à approfondir votre maîtrise théorique, nos enseignants s'engagent à élaborer avec vous un parcours pédagogique sur mesure, adapté à votre progression individuelle.

Au cours de nos sessions de solfège, vous explorerez l'univers de la lecture de notes, l'harmonie, le rythme, et l'oreille musicale. Vous serez initié à des techniques diversifiées pour décoder les partitions, perfectionner votre sens du rythme, étendre votre compréhension des gammes et des accords, et affiner votre capacité à écouter et à transcrire la musique. Vous travaillerez également sur des morceaux issus de différents répertoires, ce qui enrichira votre palette de connaissances et aiguisera votre sensibilité musicale.
</p>
    </div>
...
<div class="image-container">
  <div class="image-row">
    <img src="../hassan_el_annabi/images/Cours/solfègecours1.jpg" alt="Image 1">
    <img src="../hassan_el_annabi/images/Cours/solfègecours2.jpg" alt="Image 2">
  </div>
  <div class="image-row">
    <img src="../hassan_el_annabi/images/Cours/solfègecours3.jpg" alt="Image 3">
    <img src="../hassan_el_annabi/images/Cours/solfègecours4.jpg" alt="Image 4">
  </div>
</div>
