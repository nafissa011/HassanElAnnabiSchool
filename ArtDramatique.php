...
.heading-img1 {
  ...
  <img src="../hassan_el_annabi/images/art_dramatique2.png" alt="" width="60px" class="heading-img">
  <h1 class="heading">Leçons d'Art Dramatique</h1>
</div>
    ...
    $sql = "SELECT Prof_id, Nom, Spécialité, pfp FROM professeur WHERE Spécialité = 'Art Dramatique'";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p>No art dramatique professors found.</p>";
    }
...
?>
    ...
    <div>
      <h3 class="heading1">Bienvenue dans nos cours d'Art Dramatique de l'école de Hassan El annabi !</h3>
      <p class="paragraph">Notre programme d'art dramatique est soigneusement conçu pour offrir une expérience d'apprentissage complète et enrichissante, destinée à développer la technique, la présence scénique et l'expression artistique des étudiants de tous âges et niveaux.

Sous la direction de nos professeurs expérimentés et passionnés, les élèves sont guidés à travers un curriculum rigoureux qui couvre les bases fondamentales du théâtre ainsi que des exercices spécifiques visant à renforcer la voix, la gestuelle et l'interprétation.

Chaque leçon est une exploration de la puissance et de la subtilité de cet art expressif, permettant aux élèves de développer non seulement leurs compétences techniques, mais aussi leur sensibilité artistique et leur capacité à communiquer des émotions à travers leurs performances.

Que vous soyez un débutant enthousiaste ou un acteur expérimenté cherchant à perfectionner votre art, nos cours d'art dramatique offrent un environnement stimulant où chacun peut s'épanouir et réaliser son plein potentiel dans le monde captivant du théâtre.
</p>
    </div>
...
<div class="image-container">
  <div class="image-row">
    <img src="../hassan_el_annabi/images/Cours/art1.jpg" alt="Image 1">
    <img src="../hassan_el_annabi/images/Cours/art2.jpg" alt="Image 2">
  </div>
  <div class="image-row">
    <img src="../hassan_el_annabi/images/Cours/art3.jpg" alt="Image 3">
    <img src="../hassan_el_annabi/images/Cours/art4.jpg" alt="Image 4">
  </div>
</div>
